...
public class Tournament {
	...
	public static void launchTournament(String gameName)
	{
	...
	public static void launchTournament(GameState st, GameMove move) {
		...
		try {
			...
			for (i = 0; i < NUM_CLIENTS; i++) {
				clients[i] = new Client(socket, INIT_LIMIT, MOVE_LIMIT,
...
//								GameThread game;
//								if (g.h >= 0) {
//									game = new GameThread(clients[g.h], g.h,
//											null, g.a, g.gameNum, move.clone(),
//											st.clone());
//								} else {
//									game = new GameThread(null, g.h,
//											clients[g.a], g.a, g.gameNum,
//											move.clone(), st.clone());
//								}
//								game.start();
...
//										clients[actualPlayer].name, remain);
//								cont = true;
//							}
//						} else if ((headToHeadSummary[p1][p2][0] >= consecWins && headToHeadSummary[p1][p2][1]
//								+ headToHeadSummary[p1][p2][2] == 0)
//								|| (headToHeadSummary[p1][p2][0]
//										+ headToHeadSummary[p1][p2][2] == 0 && headToHeadSummary[p1][p2][1] >= consecWins)) {
//							schedule.remove(i);
//							remain--;
...
//							}
	...
	public static void main(String[] args) {
		...
		String gameName = tournamentParams.string("GAME");
		...
		Tournament.launchTournament(gameName);
